        ...
        <section className="w-full px-6 lg:px-16 grid grid-cols-1 lg:grid-cols-12 gap-y-8 lg:gap-y-0 pt-16 pb-24 md:pt-20 md:pb-15 bg-[#F0F0F0]" id="about">
            <div className="w-full lg:col-span-7 lg:row-start-1 flex flex-col">
                <motion.h1
                    ...
                    className="text-4xl sm:text-5xl md:text-6xl lg:text-[66px] xl:text-[66px] font-medium tracking-tighter leading-[1.0] uppercase text-[#2A2A2A]"
                >
                    A digital design studio<br className="hidden sm:inline" /> driven by research<br className="hidden md:inline" /> & strategy
                </motion.h1>
            </div>

            <div className="w-full lg:col-span-4 lg:col-start-8 lg:ml-12 lg:row-start-2 flex flex-col lg:items-end mt-4 lg:mt-0">
                <motion.div
                ...
                >
                    <p className="text-[11px] sm:text-[16px] leading-relaxed uppercase tracking-tight text-[#2A2A2A]/85">
